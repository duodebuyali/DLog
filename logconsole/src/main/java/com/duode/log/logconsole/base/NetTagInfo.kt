 ...
 */
data class NetTagInfo(var moduleTag: String, var componentTag: String, var groupTag: String, var selfTag: String,
  ...
  fun isSame(moduleTag: String, componentTag: String, groupTag: String, selfTag: String): Boolean {
    return isSameGroup(moduleTag, componentTag, groupTag) && selfTag == this.selfTag
  }

  fun isReallySame(tagInfo: NetTagInfo): Boolean {
    return isSame(tagInfo.moduleTag, tagInfo.componentTag, tagInfo.groupTag, tagInfo.selfTag) && tagInfo.requestMills == this.requestMills
  }
}