...
interface IBaseDao<T> {
  ...
  fun insert(vararg element: T): Completable

  /**
   * @return 返回插入的数据的_id
   * */
  @Insert(onConflict = OnConflictStrategy.REPLACE)
  fun insertReturnId(vararg element: T): Maybe<LongArray>
   ...
   * */
  @Delete
  fun delete(vararg element: T): Completable

  /**
   * @return  表示删除成功了多少行
   * */
  @Delete
  fun deleteReturnNum(vararg element: T): Single<Int>
   ...
   * */
  @Update
  fun updateReturnNum(vararg element: T): Single<Int>
